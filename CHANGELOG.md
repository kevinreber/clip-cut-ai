...
### Added
- Project Folders & Tags — organize projects into color-coded folders and apply free-form tags for better library management; folder sidebar, tag badges on project cards, tag/folder filtering, and batch organization actions
